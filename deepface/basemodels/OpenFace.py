...
def loadModel(
    ...
    if os.path.isfile(f"{home}/.deepface/weights/openface_weights.h5") != True:
        print("openface_weights.h5 will be downloaded...")

        output = f"{home}/.deepface/weights/openface_weights.h5"
        gdown.download(url, output, quiet=False)

    # -----------------------------------

    model.load_weights(f"{home}/.deepface/weights/openface_weights.h5")
